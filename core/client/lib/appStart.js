...
var connect = function(){
    ...
    if(web3.isConnected()) {
        ...
        Meteor.setTimeout(function(){
            // if in mist, tell to start iron, otherwise start with RPC
            var gethRPC = (web3.admin) ? 'iron' : 'iron --rpc --rpccorsdomain "'+window.location.protocol + '//' + window.location.host+'"';
